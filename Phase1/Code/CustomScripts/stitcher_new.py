...
class Stitcher:
    def __init__(self):
        """
        Stitcher Class for Panorama Stitching of the images
        """
        self.descriptiopn = "Stitcher Class for Panorama Stitching of the images"
        ...
        self.inlier_percent_threshold = 95
        self.logger = setup_logger()

    def get_corners(self, img_orig):
        """
        Detect corners in the image using Harris Corner Detection
        :param img: Input image (Expects in Grayscale)
        :param threshold: threshold value for Harris Corner Detection
    ...
    def detect_and_describe(self, image):
        ...
        return feat_vect, coords, fp, corners, c_img, best_corners
    ...
    def match_and_compute_homography(self, feat_vect1, feat_vect2, coords1, coords2):
        ...
        # Homography
        if len(feature_matches) < 10:
            return feature_matches, None, None
